...
const builtAppDirectory = resolve(projectRoot, ".next");
const outputDirectory = resolve(projectRoot, ".mail-drop");
const port = 4015;

if (!existsSync(builtAppDirectory)) {
...
const server = spawn(process.execPath, [nextBin, "start", "-p", String(port), "-H", "127.0.0.1"], {
  ...
  env: {
    ...process.env,
    MAIL_TRANSPORT_MODE: "file",
    MAIL_FILE_OUTPUT_DIRECTORY: ".mail-drop",
  },
